  ...
  useEffect(() => {
    const fetchOrder = async () => {
      try {
        ...
        setOrder({
          additional_request: data.orderData.additional_request,
          estimated_completion_date: data.orderData.estimated_completion_date,
          notes_for_internal_use: data.orderData.notes_for_internal_use,
          notes_for_customer: data.orderData.notes_for_customer,
        ...
        calculateTotalPrice(
          data.services,
          data.orderData.additional_request_price
        );
